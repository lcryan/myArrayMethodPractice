...
const sixTeenthCentury = inventors.filter((inventorDetails) => {
    return inventorDetails.year > 1499 && inventorDetails.year < 1600;
})
...
const inventoryears = inventors.map((inventorData) => {
    return inventorData.year;
});
